...
`http-server` is an open source project and we love to receive contributions from our community.  There are many ways to contribute.  For example, consider writing tutorials or blog posts, improving the documentation, submitting bug reports and feature requests or forking the repository and enhancing the project.  Please avoid using the issue tracker for [support questions].
...
At this point, you're ready to make your changes! Feel free to ask for help; everyone is a beginner at first.  As a tip, if a maintainer asks you to "rebase" your PR, they're saying that a lot of code has changed, and that you need to update your branch so it's easier to merge.
